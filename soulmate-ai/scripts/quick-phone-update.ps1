...
$Files = @(
    ...
    "components/keyboard-spacer.tsx",
    ...
    "lib/agent/run-council-agent.ts",
    ...
    "lib/parse-critique-segments.ts",
    ...
    "supabase/migrations/20260804060000_user_token_usage.sql",
    "types/access.ts",
    "types/billing.ts",
