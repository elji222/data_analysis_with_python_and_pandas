...
if ($ThemeText -notmatch "2025-07-13") {
    throw "constants/chat-theme.ts is still old after download. Expected UI 2025-07-13."
}
...
Write-Host "  4. Look for UI 2025-07-13 under Soulmate AI in the left sidebar"
Write-Host ""
