...
Write-Host ""
Write-Host "Phone and PC must be on the SAME Wi-Fi for the local link below."
Write-Host "For internet anywhere (phone data, other Wi-Fi), use:"
...
if ($phoneUrl) {
    ...
    Write-Host "============================================"
    Write-Host ""
    Write-Host "Copy that exact link. Keep this window open while you use the app."
    Write-Host ""
    Write-Host "For INTERNET access anywhere (not just home Wi-Fi), open:"
    Write-Host "  https://soulmate-ai.expo.app/chat"
    Write-Host ""
} else {
    Write-Host ""
